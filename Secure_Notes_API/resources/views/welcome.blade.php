...
<head>
    ...
    <title>واجهة برمجة الملاحظات الآمنة</title>
...
<div
    ...
    <div class="flex flex-col lg:flex-row-reverse">
        ...
        <div class="flex-1 p-8 lg:p-16 flex flex-col justify-center text-right">
            ...
            <h1 class="text-4xl lg:text-6xl font-extrabold text-gray-900 dark:text-white mb-6 leading-tight">
                احفظ ملاحظاتك <br/>
                <span class="text-[#4f46e5]">بأمان تام.</span>
            </h1>

            <p class="text-lg text-gray-600 dark:text-gray-400 mb-10 max-w-md">
                واجهة برمجة تطبيقات متطورة لإدارة الملاحظات الشخصية مع تشفير وحماية عالية. ابدأ الآن بدمج نظام الملاحظات في تطبيقك بكل سهولة.
            </p>
        ...
        <div
            ...
            <div class="grid grid-cols-2 gap-4 w-full max-w-md">
                <div
                    ...
                    <h3 class="font-bold dark:text-white">الملاحظات</h3>
                    <p class="text-sm text-gray-500">إدارة كاملة للمحتوى</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">حماية عالية</h3>
                    <p class="text-sm text-gray-500">تشفير البيانات الحساسة</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">Sanctum</h3>
                    <p class="text-sm text-gray-500">توثيق هوية آمن</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">أداء سريع</h3>
                    <p class="text-sm text-gray-500">استجابة فورية للطلبات</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div
        ...
        <p class="text-xs text-gray-400 font-medium uppercase tracking-widest">© 2025 نظام الملاحظات الآمن</p>
