...
<head>
    ...
    <title>{{ config('app.name', 'RealEstate API') }}</title>
...
<div
    ...
    <div class="flex flex-col lg:flex-row">
        ...
        <div class="flex-1 p-8 lg:p-16 flex flex-col justify-center">
            <div class="mb-6">
                    <span
                        class="px-4 py-1.5 bg-blue-50 dark:bg-blue-900/20 text-[#2563eb] text-sm font-bold rounded-full uppercase tracking-wider">
                        Real Estate API
                    </span>
            </div>
            ...
            <h1 class="text-4xl lg:text-6xl font-extrabold text-gray-900 dark:text-white mb-6 leading-tight">
                Find your dream <br/>
                <span class="text-[#2563eb]">property.</span>
            </h1>

            <p class="text-lg text-gray-600 dark:text-gray-400 mb-10 max-w-md">
                Access a comprehensive database of apartments, villas, and lands. Our API provides seamless integration for real estate listings and management.
            </p>
        ...
        <div
            class="flex-1 bg-gray-50 dark:bg-[#161616] p-8 lg:p-12 flex items-center justify-center border-l border-gray-100 dark:border-white/5">
            <div class="grid grid-cols-2 gap-4 w-full max-w-md">
                <div
                    ...
                    <p class="text-sm text-gray-500">Villas & Apartments</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">Locations</h3>
                    <p class="text-sm text-gray-500">City-based search</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">Pricing</h3>
                    <p class="text-sm text-gray-500">Sale & Rent options</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">Secure API</h3>
    ...
    <!-- Footer -->
    <div
        class="bg-gray-50 dark:bg-[#0c0c0c] px-8 py-4 border-t border-gray-100 dark:border-white/5 flex justify-between items-center">
        <p class="text-xs text-gray-400 font-medium uppercase tracking-widest">© 2025 Real Estate API System</p>
