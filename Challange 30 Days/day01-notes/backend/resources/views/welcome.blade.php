...
<head>
    ...
    <title>ملاحظاتي - منصة تدوين الأفكار الذكية</title>
...
<div
        ...
        <div class="flex-1 p-8 lg:p-16 flex flex-col justify-center text-right">
            <div class="mb-6">
                    <span
                        ...
                        نظام إدارة الملاحظات v1.0
                    </span>
            </div>

            <h1 class="text-4xl lg:text-6xl font-extrabold text-gray-900 dark:text-white mb-6 leading-tight">
                دوّن أفكارك <br/>
                <span class="text-indigo-600 dark:text-indigo-400">بكل سهولة وسرعة.</span>
            </h1>

            <p class="text-lg text-gray-600 dark:text-gray-400 mb-10 max-w-md">
                منصة "ملاحظاتي" توفر لك مساحة آمنة ومنظمة لتدوين أفكارك، ملاحظاتك، وخواطرك اليومية. ابقَ منظماً ووصولاً
                سريعاً لكل ما يهمك في أي وقت.
            </p>
        ...
        <div
            ...
            <div class="grid grid-cols-2 gap-4 w-full max-w-md">
                <div
                    ...
                    <h3 class="font-bold dark:text-white">تدوين سريع</h3>
                    <p class="text-sm text-gray-500">أضف ملاحظاتك بضغطة زر واحدة وبكل بساطة</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">تنظيم ذكي</h3>
                    <p class="text-sm text-gray-500">صنف ملاحظاتك للوصول إليها بسهولة تامة</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">وصول آمن</h3>
                    <p class="text-sm text-gray-500">ملاحظاتك محمية ومشفرة لخصوصية تامة</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">بحث متقدم</h3>
                    <p class="text-sm text-gray-500">ابحث في محتوى ملاحظاتك بسرعة فائقة</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div
        ...
        <p class="text-xs text-gray-400 font-medium uppercase tracking-widest">© 2026 ملاحظاتي | Notes Manager
            Platform</p>
