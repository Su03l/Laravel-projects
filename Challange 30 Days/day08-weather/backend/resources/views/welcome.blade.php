...
<head>
    ...
    <title>تطبيق الطقس - رفيقك لمعرفة حالة الجو</title>
...
<body class="bg-gray-50 dark:bg-[#0a0a0a] min-h-screen flex items-center justify-center p-4">
    ...
    <div
            ...
            <div class="flex-1 p-8 lg:p-16 flex flex-col justify-center text-right">
                <div class="mb-6">
                    <span
                        ...
                        تطبيق الطقس الذكي v1.0
                    </span>
                </div>

                <h1 class="text-4xl lg:text-6xl font-extrabold text-gray-900 dark:text-white mb-6 leading-tight">
                    اعرف حالة الطقس <br />
                    <span class="text-indigo-600 dark:text-indigo-400">بكل دقة وسهولة.</span>
                </h1>

                <p class="text-lg text-gray-600 dark:text-gray-400 mb-10 max-w-md">
                    يوفر لك تطبيقنا معلومات شاملة عن حالة الطقس في مختلف مدن العالم، مع تحديثات لحظية وبيانات دقيقة تساعدك على التخطيط ليومك بشكل أفضل.
                </p>
            ...
            <div
                ...
                <div class="grid grid-cols-2 gap-4 w-full max-w-md">
                    <div
                        ...
                        <h3 class="font-bold dark:text-white">توقعات لحظية</h3>
                        <p class="text-sm text-gray-500">بيانات دقيقة ومحدثة على مدار الساعة</p>
                    </div>
                    ...
                    <div
                        ...
                        <h3 class="font-bold dark:text-white">بحث عالمي</h3>
                        <p class="text-sm text-gray-500">ابحث عن حالة الجو في أي مدينة</p>
                    </div>
                    ...
                    <div
                        ...
                        <h3 class="font-bold dark:text-white">سجل البحث</h3>
                        <p class="text-sm text-gray-500">احتفظ بالمدن المفضلة للوصول السريع</p>
                    </div>
                    ...
                    <div
                        ...
                        <h3 class="font-bold dark:text-white">تفاصيل دقيقة</h3>
                        <p class="text-sm text-gray-500">معلومات عن الرياح والرطوبة والضغط</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <p class="text-xs text-gray-400 font-medium uppercase tracking-widest">© 2026 تطبيق الطقس | Weather App Platform</p>
