...
<head>
    ...
    <title>JobBoard - منصة التوظيف التقني</title>
...
<div
    ...
    <div class="flex flex-col lg:flex-row-reverse">
        ...
        <div class="flex-1 p-8 lg:p-16 flex flex-col justify-center text-right">
            ...
            <h1 class="text-4xl lg:text-6xl font-extrabold text-gray-900 dark:text-white mb-6 leading-tight">
                ابحث عن وظيفة أحلامك <br/>
                <span class="text-indigo-600 dark:text-indigo-400">في عالم التقنية.</span>
            </h1>

            <p class="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-md">
                منصة JobBoard تربط بين أفضل المواهب التقنية وأكبر الشركات. ابدأ مسيرتك المهنية اليوم أو ابحث عن الموظف المثالي.
            </p>
            ...
            <div class="grid grid-cols-3 gap-4 mb-10">
                ...
                <div class="bg-gray-50 dark:bg-white/5 p-4 rounded-2xl border border-gray-100 dark:border-white/5">
                    <div class="text-2xl font-bold text-emerald-500">{{ $stats['jobs'] }}</div>
                    <div class="text-sm text-gray-500 dark:text-gray-400">وظيفة</div>
                </div>
                <div class="bg-gray-50 dark:bg-white/5 p-4 rounded-2xl border border-gray-100 dark:border-white/5">
                    <div class="text-xl font-bold text-amber-500">{{ $stats['tags'] }}</div>
                    <div class="text-sm text-gray-500 dark:text-gray-400">مهارة تقنية</div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                @empty
                    <div class="text-center py-12">
                        <div class="text-gray-400 mb-2">لا توجد وظائف بعد</div>
                        <p class="text-sm text-gray-500">كن أول من ينشر وظيفة تقنية!</p>
                    </div>
                @endforelse
            </div>
    ...
    <div
        ...
        <p class="text-xs text-gray-400 font-medium uppercase tracking-widest">© 2026 JobBoard | Job Board Platform</p>
