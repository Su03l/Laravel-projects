...
<head>
    ...
    <title>نزل - منصة حجز العقارات الذكية</title>
...
<div
    ...
    <div class="flex flex-col lg:flex-row-reverse">
        ...
        <div class="flex-1 p-8 lg:p-16 flex flex-col justify-center text-right">
            ...
            <p class="text-lg text-gray-600 dark:text-gray-400 mb-10 max-w-md">
                منصة "نزل" توفر لك تجربة فريدة للبحث عن العقارات وحجزها. سواء كنت تبحث عن إقامة قصيرة أو تدير عقاراتك الخاصة، نحن نوفر لك الأدوات اللازمة للنجاح.
            </p>
        ...
        <div
            ...
            <div class="grid grid-cols-2 gap-4 w-full max-w-md">
                <div
                    ...
                    <h3 class="font-bold dark:text-white">إدارة العقارات</h3>
                    <p class="text-sm text-gray-500">إضافة وتعديل القوائم العقارية بسهولة</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">نظام الحجز</h3>
                    <p class="text-sm text-gray-500">تتبع الحجوزات وتوافر العقارات</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">المستخدمين</h3>
                    <p class="text-sm text-gray-500">إدارة حسابات المستأجرين والملاك</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">تقارير الأداء</h3>
                    <p class="text-sm text-gray-500">تحليلات دقيقة للعوائد والإشغال</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div
        ...
        <p class="text-xs text-gray-400 font-medium uppercase tracking-widest">© 2026 نزل | Nuzul Booking Platform</p>
