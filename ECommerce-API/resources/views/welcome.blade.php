...
<head>
    ...
    <title>متجر إلكتروني متطور - API</title>
...
<div
    ...
    <div class="flex flex-col lg:flex-row-reverse">
        ...
        <div class="flex-1 p-8 lg:p-16 flex flex-col justify-center text-right">
            ...
            <p class="text-lg text-gray-600 dark:text-gray-400 mb-10 max-w-md">
                واجهة برمجة تطبيقات متكاملة لإدارة المنتجات، التصنيفات، والطلبات. صُممت لتوفير تجربة تسوق سلسة وآمنة مع أداء عالٍ.
            </p>
        ...
        <div
            ...
            <div class="grid grid-cols-2 gap-4 w-full max-w-md">
                <div
                    ...
                    <p class="text-sm text-gray-500">إضافة وتعديل المخزون</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">التصنيفات</h3>
                    <p class="text-sm text-gray-500">تنظيم المنتجات بفعالية</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">تحليلات المبيعات</h3>
                    <p class="text-sm text-gray-500">تتبع الأداء والنمو</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div
        ...
        <p class="text-xs text-gray-400 font-medium uppercase tracking-widest">© 2025 متجر إلكتروني | E-Commerce API</p>
