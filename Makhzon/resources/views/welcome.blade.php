...
<head>
    ...
    <title>مخزون - نظام إدارة المستودعات الذكي</title>
...
<div
    ...
    <div class="flex flex-col lg:flex-row-reverse">
        ...
        <div class="flex-1 p-8 lg:p-16 flex flex-col justify-center text-right">
            <div class="mb-6">
                    <span
                        class="px-4 py-1.5 bg-slate-100 dark:bg-slate-900/40 text-slate-800 dark:text-slate-200 text-sm font-bold rounded-full uppercase tracking-wider">
                        نظام مخزون v1.0
                    </span>
            </div>

            <h1 class="text-4xl lg:text-6xl font-extrabold text-gray-900 dark:text-white mb-6 leading-tight">
                أدر مستودعك بذكاء <br/>
                <span class="text-slate-700 dark:text-slate-400">دقة، كفاءة، وسهولة.</span>
            </h1>

            <p class="text-lg text-gray-600 dark:text-gray-400 mb-10 max-w-md">
                حل متكامل لإدارة المنتجات، تتبع المخزون، وإدارة الموردين. صُمم "مخزون" ليمنحك السيطرة الكاملة على عملياتك التجارية في مكان واحد.
            </p>
        ...
        <div
            ...
            <div class="grid grid-cols-2 gap-4 w-full max-w-md">
                <div
                    ...
                    <h3 class="font-bold dark:text-white">إدارة المنتجات</h3>
                    <p class="text-sm text-gray-500">تنظيم وتصنيف المنتجات بدقة عالية</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">تتبع المخزون</h3>
                    <p class="text-sm text-gray-500">مراقبة مستويات المخزون لحظة بلحظة</p>
                </div>
                ...
                <div
                    ...
                    <h3 class="font-bold dark:text-white">الموردون</h3>
                    <p class="text-sm text-gray-500">إدارة بيانات الموردين وعمليات التوريد</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-sm text-gray-500">تحليلات دقيقة لاتخاذ قرارات أفضل</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div
        ...
        <p class="text-xs text-gray-400 font-medium uppercase tracking-widest">© 2026 مخزون | Makhzon Inventory Management</p>
